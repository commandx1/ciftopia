...
const FeatureCard = ({ icon, title, description, color, iconBg, isLarge }: FeatureCardProps) => (
  ...
  >
    ...
    <h3 className=' text-2xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-rose-primary transition-colors'>
      {title}
    </h3>
...
export const Features = () => {
  const mainFeatures = [
    {
      ...
      title: 'Anılar',
      description:
        'Birlikte yaşadığınız özel anları timeline formatında kaydedin. Tarih, konum ve fotoğraflarla zenginleştirin.',
  ...
  return (
    <section
      id='features'
      className='py-24 bg-gradient-to-b from-white to-cream-white dark:from-slate-950 dark:to-slate-900'
    >
      <div className='max-w-7xl mx-auto px-6'>
        <div className='text-center mb-16 space-y-4'>
          ...
          <p className='text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto'>
            Birlikte yaşadığınız her anı, her duyguyu özel bir yerde saklayın. Çiftopia ile sevginiz dijital dünyada da
            ölümsüzleşsin.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          <div className='bg-indigo-50 dark:bg-indigo-900/10 rounded-3xl p-8 border-2 border-indigo-100 dark:border-indigo-900/30 hover:shadow-lg transition-all'>
            <div className='w-14 h-14 bg-indigo-500 rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg shadow-indigo-500/30'>
              <MessageCircleQuestion size={24} />
            </div>
            <h4 className='font-bold text-xl text-gray-900 dark:text-white mb-3'>Günlük Sorular</h4>
            <p className='text-gray-600 dark:text-gray-400'>
              Her gün sorularınızı cevaplayın, birbirinizi daha iyi tanıyın ve bağınızı güçlendirin. AI modelimiz
              cevaplarınızı analiz ederek özel yorumlar sunar.
            </p>
          </div>
          <div className='bg-pink-50 dark:bg-pink-900/10 rounded-3xl p-8 border-2 border-pink-100 dark:border-pink-900/30 hover:shadow-lg transition-all'>
            <div className='w-14 h-14 bg-pink-500 rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg shadow-pink-500/30'>
              <ClipboardList size={24} />
            </div>
            <h4 className='font-bold text-xl text-gray-900 dark:text-white mb-3'>Aşk Quizleri</h4>
            <p className='text-gray-600 dark:text-gray-400'>
              Eğlenceli quizlerle birbirinizi keşfedin. Bakalım kim kimi daha iyi tanıyor? 😉
            </p>
          </div>
          <div className='bg-blue-50 dark:bg-blue-900/10 rounded-3xl p-8 border-2 border-blue-100 dark:border-blue-900/30 hover:shadow-lg transition-all'>
            ...
            <h4 className='font-bold text-xl text-gray-900 dark:text-white mb-3'>Hayalleriniz</h4>
            <p className='text-gray-600 dark:text-gray-400'>
              Birlikte yapılacaklar listenizi oluşturun ve tamamladıkça işaretleyin.
            </p>
          </div>
          <div className='bg-rose-50 dark:bg-rose-900/10 rounded-3xl p-8 border-2 border-rose-100 dark:border-rose-900/30 hover:shadow-lg transition-all'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              Yıldönümleri, ilk öpücük, ilk buluşma gibi özel tarihleri kaydedin.
            </p>
          </div>
          ...
          <div className='bg-purple-50 dark:bg-purple-900/10 rounded-3xl p-8 border-2 border-purple-100 dark:border-purple-900/30 hover:shadow-lg transition-all'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              Ortak müzik zevkinizi yansıtan özel bir playlist oluşturun.
            </p>
          </div>
          <div className='bg-teal-50 dark:bg-teal-900/10 rounded-3xl p-8 border-2 border-teal-100 dark:border-teal-900/30 hover:shadow-lg transition-all'>
            ...
            <p className='text-gray-600 dark:text-gray-400'>
              Gelecekte açılacak mektuplar yazın. Belirlediğiniz tarihte açılır.
            </p>
          </div>
        </div>
      </div>
