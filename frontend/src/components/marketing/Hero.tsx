...
export const Hero = () => {
  return (
    <section
      id='hero-section'
      className='relative bg-gradient-to-br from-cream-white via-pink-50 to-rose-50 dark:from-slate-950 dark:via-slate-900 dark:to-rose-950/20 overflow-hidden min-h-[700px] flex items-center'
    >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          <div className='space-y-8 animate-in fade-in slide-in-from-left duration-700'>
            ...
            <h1 className=' text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white leading-tight'>
              Aşkınızın{' '}
              <span className='text-transparent bg-clip-text bg-gradient-to-r from-rose-primary to-coral-warm'>
                Dijital Yuvası
              </span>
            </h1>
            ...
            <div className='flex flex-col sm:flex-row gap-4 pt-4'>
              ...
              <Button
                size='lg'
                variant='outline'
                className='bg-white text-rose-primary border-2 border-rose-primary px-8 py-7 rounded-full font-bold text-lg hover:bg-rose-50 transition-all w-full sm:w-auto dark:bg-slate-900 dark:hover:bg-slate-800'
              >
          ...
          <div className='relative hidden lg:block animate-in fade-in slide-in-from-right duration-1000'>
            <div className='relative w-full h-[550px] rounded-[3rem] overflow-hidden shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-700'>
              <Image className='object-cover' src='/banner_image.png' alt='Romantic couple' fill priority />
            </div>
