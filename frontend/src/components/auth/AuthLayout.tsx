...
export const AuthLayout = ({
  children,
  quote = 'Aşk, iki kalbin bir ritimde atmasıdır',
  isWide = false
}: AuthLayoutProps) => {
  return (
    <div className='min-h-screen flex bg-cream-white dark:bg-slate-950'>
      ...
      >
        <div className={cn('w-full animate-in fade-in duration-500', isWide ? 'max-w-5xl' : 'max-w-md')}>
      ...
      <div className='hidden lg:flex w-[40%] bg-gradient-to-br from-rose-500 via-pink-500 to-purple-500 relative overflow-hidden items-center justify-center p-12'>
        ...
        <div className='relative z-10 text-center max-w-lg'>
          ...
          <h2 className=' text-4xl font-bold text-white mb-8 leading-tight'>&quot;{quote}&quot;</h2>
